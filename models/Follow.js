...
let Follow = function(followedUsername, authorId) {
    ...
    this.authorId = authorId // follower id
    this.errors = []
}
...
Follow.prototype.validate = async function(action) {
    ...
    if (followedAccount) {
        this.followedId = followedAccount._id // the id that is been followed
    } else {
    ...
    // prevent user from stopping following someone they do not followed.
    if (action == "delete") {
...
// is current visitor follwing the profile
