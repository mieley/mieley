...
export default class RegistrationForm {
    ...
    events() {
        ...
        // blur event event occurs when field losses focus
    ...
    // Methods
    formSubmitHandler() { // this handle error when some or all the registration field are left empty
    ...
    isDifferent(el, handler) { // function to run when value of fields changes
